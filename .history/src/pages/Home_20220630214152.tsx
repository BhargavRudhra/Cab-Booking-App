    ...
    <IonPage>
      <IonContent>
        ...
        <IonCard className='main-card'>
            ...
            <IonButton className='facebook-btn' color="light"><img id='face-img' src={image} alt='' />Facebook</IonButton>
            <IonButton className='insta-btn' color="light"><img src={insta} alt='' />Instagram</IonButton>
            <IonCardContent className='copyrights'> Copyright</IonCardContent>
        </IonCard>
      </IonContent>
    </IonPage>
  );
