...
const Loginpage = () => {
  ...
  if(showLoading){
    ...
    return <IonLoading isOpen = {showLoading} onDidDismiss={() => setShowLoading(false)} message={'SigningUp!...'} duration={3000}/>
        ...
        <IonGrid className="login-main-grid">
          ...
          <IonRow className="login-text-row">
            <IonText className="login-text">
              If you don't have account? <IonText className="SignUp-text" onClick={Signup} onIonChange={clearInputs}>SignUp</IonText> here
            </IonText>
          </IonRow>
